...
function Concerned() {
  const id = useId();
  const path1 = `concerned-path-${id}`;
  const mask1 = `concerned-mask-${id}`;
  return (
    <g id="Mouth/Concerned" transform="translate(2.000000, 52.000000)">
      ...
      <use fillOpacity="0.699999988" fill="#000000" fillRule="evenodd" transform="translate(54.003637, 22.500000) scale(1, -1) translate(-54.003637, -22.500000)" xlinkHref={`#${path1}`} />
...
function Eating() {
  return (
    <g id="Mouth/Eating" transform="translate(2.000000, 52.000000)">
      <g opacity="0.599999964" strokeWidth="1" transform="translate(28.000000, 6.000000)" fillOpacity="0.599999964" fill="#000000">
      ...
      <circle fillOpacity="0.2" fill="#FF4646" cx="17" cy="15" r="9" />
      <circle fillOpacity="0.2" fill="#FF4646" cx="91" cy="15" r="9" />
    </g>
  );
}
...
function Grimace() {
  const id = useId();
  const path1 = `grimace-path-${id}`;
  const mask1 = `grimace-mask-${id}`;
  return (
...
function Sad() {
  return (
    <g id="Mouth/Sad" transform="translate(2.000000, 52.000000)" fillOpacity="0.699999988" fill="#000000">
...
function ScreamOpen() {
  const id = useId();
  const path1 = `scream-path-${id}`;
  const mask1 = `scream-mask-${id}`;
  return (
    <g id="Mouth/Scream-Open" transform="translate(2.000000, 52.000000)">
      ...
      <use fillOpacity="0.699999988" fill="#000000" fillRule="evenodd" transform="translate(54.000000, 26.999998) scale(1, -1) translate(-54.000000, -26.999998)" xlinkHref={`#${path1}`} />
      <rect fill="#FFFFFF" fillRule="evenodd" mask={`url(#${mask1})`} x="39" y="2" width="31" height="16" rx="5" />
      <g strokeWidth="1" fillRule="evenodd" mask={`url(#${mask1})`} fill="#FF4F6D">
...
function Smile() {
  const id = useId();
  const path1 = `smile-path-${id}`;
  const mask1 = `smile-mask-${id}`;
  return (
...
function Tongue() {
  const id = useId();
  const path1 = `tongue-path-${id}`;
  const mask1 = `tongue-mask-${id}`;
  return (
    <g id="Mouth/Tongue" transform="translate(2.000000, 52.000000)">
      <defs>
        <path d="M29,15.6086957 C30.410031,25.2313711 41.062182,33 54,33 C66.9681454,33 77.6461342,25.183301 79,14.7391304 C79.1012093,14.3397326 78.775269,13 76.826087,13 C56.838426,13 41.7395748,13 31.173913,13 C29.3833142,13 28.870211,14.2404669 29,15.6086957 Z" id={path1} />
      </defs>
      <mask id={mask1} fill="white"><use xlinkHref={`#${path1}`} /></mask>
      <use fillOpacity="0.699999988" fill="#000000" fillRule="evenodd" xlinkHref={`#${path1}`} />
      <rect fill="#FFFFFF" fillRule="evenodd" mask={`url(#${mask1})`} x="39" y="2" width="31" height="16" rx="5" />
...
function Twinkle() {
  return (
    <g id="Mouth/Twinkle" transform="translate(2.000000, 52.000000)" fillOpacity="0.599999964" fillRule="nonzero" fill="#000000">
...
function Vomit() {
  const id = useId();
  const path1 = `vomit-path1-${id}`;
  const path2 = `vomit-path2-${id}`;
  const mask1 = `vomit-mask-${id}`;
  const filter1 = `vomit-filter-${id}`;
  return (
    <g id="Mouth/Vomit" transform="translate(2.000000, 52.000000)">
      ...
      <use fillOpacity="0.699999988" fill="#000000" fillRule="evenodd" transform="translate(54.000000, 21.499998) scale(1, -1) translate(-54.000000, -21.499998)" xlinkHref={`#${path1}`} />
...
export const mouthMap: Record<MouthType, () => React.JSX.Element> = {
